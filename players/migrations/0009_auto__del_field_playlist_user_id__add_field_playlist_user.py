...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Playlist.user'
        db.add_column('players_playlist', 'user',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Playlist.user_id'
        raise RuntimeError("Cannot reverse this migration. 'Playlist.user_id' and its values cannot be restored.")
        # Deleting field 'Playlist.user'
        db.delete_column('players_playlist', 'user_id')
